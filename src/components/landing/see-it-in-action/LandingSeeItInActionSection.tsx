...
export default function LandingSeeItInActionSection({ animRef, isVisible }: Props) {
  ...
  return (
    <Container maxWidth="lg" sx={{ mb: 14 }}>
      <Box ref={animRef} className={`scroll-section ${isVisible ? 'visible' : ''}`}>
        ...
        <Box sx={{ maxWidth: 1000, mx: 'auto' }}>
          ...
          <Box className="reveal delay-3">
            ...
            >
              ...
              >
                The scoreboard shows <strong>Home Team: 14</strong> and{' '}
                <strong>Away Team: 7</strong>. These numbers determine the winning square.
              </Typography>
            </LandingStepCard>
          </Box>

          <Box className="reveal delay-4">
            <LandingStepCard
              step={3}
